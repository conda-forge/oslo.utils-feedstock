About oslo.utils-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/oslo.utils-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=735&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/oslo.utils-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `oslo.utils` can be installed with `conda`:
...
```
mamba install oslo.utils
```

It is possible to list all of the versions of `oslo.utils` available on your platform with `conda`:
...
```
mamba search oslo.utils --channel conda-forge
```
...
mamba repoquery search oslo.utils --channel conda-forge

# List packages depending on `oslo.utils`:
mamba repoquery whoneeds oslo.utils --channel conda-forge

# List dependencies of `oslo.utils`:
mamba repoquery depends oslo.utils --channel conda-forge
```
