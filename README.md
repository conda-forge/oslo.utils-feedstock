...
pixi global install oslo.utils
```
...
It is possible to list all of the versions of `oslo.utils` available on your platform:
...
```
pixi search oslo.utils --channel conda-forge
```
